...
function initializeTheme() {
  const savedTheme = localStorage.getItem('es6_converter_theme');
...
function setTheme(theme) {
  ...
  localStorage.setItem('es6_converter_theme', theme);
  ...
  if (typeof trackEvent === 'function') {
    trackEvent('theme_change', 'User Preference', `Theme: ${theme}`);
  }
}
